...
projectForm.onsubmit = (event) => {
  ...
  if (newProject.save()) {
    _js_utils_domWorker__WEBPACK_IMPORTED_MODULE_5__.default.appendProject(_js_models_project__WEBPACK_IMPORTED_MODULE_3__.default.get(newProject.id));
